        ...
        <div class="bg-white border-b border-slate-200">
            <div class="max-w-4xl mx-auto px-6 py-8">
                <div class="flex items-center gap-4 mb-2">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-slate-800">Edit Data Dosen</h2>
                        <p class="text-sm text-slate-500">Perbarui informasi profil bimbingan dosen terpilih.</p>
                    </div>
                </div>
            </div>
        </div>
                    ...
                    <form method="POST" action="{{ route('dosen.update', $dosen->id) }}" class="space-y-6">
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group">
                                ...
                                <textarea name="bidang_keahlian" rows="4" placeholder="Jelaskan spesialisasi dosen..."
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 transition-all text-slate-700 font-medium resize-none">{{ old('bidang_keahlian', $dosen->bidang_keahlian) }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="space-y-2">
                            ...
                            <div class="relative group w-full md:w-1/3">
                                ...
                                <input type="number" name="kuota" value="{{ old('kuota', $dosen->kuota) }}"
                                    placeholder="0" min="1"
                                    class="w-full pl-12 pr-4 py-3.5 bg-slate-50 border border-slate-200 rounded-2xl focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-600 transition-all text-slate-700 font-medium"
                                    required>
                            </div>
                        ...
                        <div class="bg-indigo-50 rounded-2xl p-4 border border-indigo-100 flex gap-4 mt-6">
                            ...
                            <div class="text-[11px] text-indigo-700 leading-relaxed">
                                <strong>Info Update:</strong> Perubahan data kuota akan langsung mempengaruhi
                                ketersediaan slot bagi mahasiswa yang akan memilih dospem di periode berjalan.
                            </div>
                        </div>
